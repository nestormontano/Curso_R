...
1. Importar el excel Data_Banco.xlsx,  hoja "Data", este excel asignarlo a una variable llamada taller_03
Pista: se utiliza library(openxlsx).. Comando taller_03 <- read.xlsx(.....)
2. Transformar las variables que sean necesarias 
Sucursal, Cajero e ID_Transaccion a texto y 
Satisfaccion a un factor ordenado
3. Haga un  resumen de las estadísticas descriptivas (Media, Desviacion, Min, Q1, Mediana, Q3, Centil 98% y Max)  para el Monto de las transacciones según el Tipo de transaccion (variable Transaccion)
Pista: Use library(plyr). comando ddply
